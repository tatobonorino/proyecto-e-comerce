    ...
    <div class="container">
        <div id='ocultaRegistro' class="container">
            ...
            <div class="fondogris col-lg-12 well">
                <div class="row">
                    <form name="suForm" action="register.php" method="POST" enctype="multipart/form-data">
                        <div class="col-sm-12">
                            <div class="row">
                            ...
                            <div class="col-sm-4 form-group">
                                <label>Email</label>
                                <input type="text" placeholder="Ingrese Email aqui.." class="form-control" name="email" value="<?php echo $pMail ?>">
                                <p id="signupError8"></p>
                            </div>
                            <div class="col-sm-4 form-group">
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <input type="text" placeholder="Confirme la clave aqui.." class="form-control" name="confirmar_password">
                                <p id="signupError10"></p>
                            </div>
                        </div>
                        <button type="button" class="btn" onclick=" validateForm();">Enviar</button>
                        <br>
                        <div class="reset">
